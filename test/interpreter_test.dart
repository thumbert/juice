...
abstract class Evaluation {
  FutureOr<int> evaluate();
}

class DbEvaluation extends Evaluation {
  @override
  FutureOr<int> evaluate() {
...
class InstantEvaluation extends Evaluation {
  @override
  FutureOr<int> evaluate() {
    return 21;
  }
...
Future<void> main() async {
  ...
  // var e1 = DbEvaluation();
  // print(await e1.evaluate());
  // print(InstantEvaluation().evaluate());
